...
function More() {
  ...
  const order = async () => {
    await axios
      .post("http://localhost:3001/order/add", data, {
        headers: {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        console.log(res);
        setCar(res.data);
        setOpisaniya(res.data.opisaniya);
      })
      .catch((err) => {
        console.log(err);
      });
            ...
            <div className="about__container">
              ...
              <div className="about__card">
                <p className="about__text">
                  <img src={star_img} alt="star" /> Марка : . . . . . . . . . .
                  . . . . {car.marka}
                </p>
                <p className="about__text">
                  <img src={star_b_img} alt="star" /> Модель : . . . . . . . . .
                  . . . . . {car.madel}
                </p>
                <p className="about__text">
                  <img src={paint_img} alt="star" /> Цвет : . . . . . . . . . .
                  . . . . . . . {car.color}
                </p>
                <p className="about__text">
                  <img src={date_img} alt="star" /> Год выпуска : . . . . . . .
                  . . . . {car.yili}
                </p>
                <p className="about__text">
                  <img src={cube_img} alt="star" /> Объем двигателя : . . . . .
                  . . . {car.divigitel}
                </p>
                <p className="about__text">
                  <img src={fuel_img} alt="star" /> Топливо:. . . . . . . . . .
                  . . . . . . . . {car.yoqilgi}
                </p>
                <p className="about__text">
                  <img src={setting_img} alt="star" /> Трансмиссия : . . . . . .
                  . {car.transmission}
                </p>
                <p className="about__text">
                  <img src={car_img} alt="star" /> Кузов : . . . . . . . . . . .
                  . . . . . . {car.kuzuv}
                </p>
                <p className="about__text">
                  <img src={speed_img} alt="star" /> Пробег: . . . . . . . . . .
                  . . . . . {car.yurgani}
                </p>
              </div>
              <div className="sale-card">
                <div className="sale-card_wrapper">
                  <span className="card-price card-price_sum">
                    Sumda<span class="valyut_uzb"> So'm</span>
                  </span>
                  ...
                  <div className="input-wrap">
                    ...
                    <input
                      onChange={(e) =>
                        setData({ ...data, ismiz: e.target.value })
                      }
                      type="text"
                      class="form-control page_title_uz"
                      name="auto_price"
                      required
              ...
              <div className="comment">
                ...
                <div className="comment_card">
                  <h4 className="comment_first">
                    Собственный импорт из Кореи. Без пробега по Украине.
                  </h4>
                  <h4 className="comment_second">{opisaniya || "hey"}</h4>
                </div>
              </div>
            </div>
          </section>
